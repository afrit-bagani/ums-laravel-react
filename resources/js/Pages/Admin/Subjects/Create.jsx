...
export default function CreateSubject({ programmes_with_courses }) {
    ...
    <>
      ...
      <div className="p-4 md:p-5 max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-gray-900">Create New Subject</h1>
            <p className="text-sm text-gray-500 mt-0.5">Fill out the details below to add a new subject to the curriculum.</p>
          </div>
        </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={data.programme_id.toString()} onValueChange={(value) => { setData('programme_id', value); setData('course_id', ''); }}>
              ...
              <div className="space-y-2">
                ...
                <Select value={data.course_id.toString()} onValueChange={(val) => setData('course_id', val)} disabled={!data.programme_id}>
                  <SelectTrigger className="w-full">
