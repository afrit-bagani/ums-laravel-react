...
export default function VerifyOtp({ login_identifier }) {
    ...
    function submit(e) {
        e.preventDefault();
        post(route("student.password.verify.store"));
    }
                            ...
                            <form className="flex flex-col gap-6" onSubmit={submit}>
                                <div className="flex flex-col items-center gap-2 text-center">
                                    ...
                                    <p className="text-sm text-balance text-muted-foreground">
                                        Enter the 6-digit OTP sent to the email registered for {login_identifier}.
                                    </p>
                                </div>
                                <FieldGroup>
                                    <Field>
                                        <div className="flex items-center justify-between w-full mb-1">
                                            ...
                                            <Button variant="outline" size="sm" className="h-7 px-2 text-xs gap-1" asChild>
                                                <Link href={route("student.password.request")}>
